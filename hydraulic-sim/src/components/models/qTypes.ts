...
export function updateDoubleActingCylinder(
  ...
  if (position < 0 || (position === 0 && velocity < 0)) {
    // Penetrating left stop or arriving at it – spring pushes right, damper opposes inward velocity
    ...
    // Penetrating right stop or arriving at it – spring pushes left, damper opposes inward velocity
